export default {
  ...
  "Please input Node Address": "ロケーターアドレスを入力してください",
  ...
  "PeerId or Mobile": "身分番号または携帯番号",
  "Invalid PeerId or Mobile": "身分番号または携帯番号が無効です",
  "Add Contacts": "連絡先を追加",
  ...
  // Account
  "LastAccessTime: ": "最近の訪問時間：",
  "LastAccessNode: ": "最近アクセスポジショナ：",
  "Instances": "インスタンス",
  "Id: ": "番号：",
  "Device: ": "デバイス：",
  ...
  "MyNodes": "ポジショナ",
  "Input PeerId to filter": "入力ポジショナ番号フィルタ",
  "Add Node": "ポジショナの追加",
  "Edit Node": "ポジショナの修正",
  ...
  "Change avatar failed": "アバターの変更に失敗しました",
  "Change name successfully": "正常に変更されたユーザー名",
  "Change name failed": "ユーザー名の変更に失敗しました",
  "Change mobile successfully": "携帯電話番号が正常に変更されました",
  "Change mobile failed": "電話番号の変更に失敗しました",
  "Change visibility setting successfully": "可視性設定の変更に成功しました",
  "Change visibility setting failed": "可視性設定の変更に失敗しました",
